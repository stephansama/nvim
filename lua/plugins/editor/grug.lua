local opts = {
	...
	-- help line config
	helpLine = { -- whether to show the help line at the top of the buffer
	enabled = true },
		...
		return {
			{
				params.line_number and ("%" .. width .. "s "):format(
					params.line_number
				) or ((" "):rep(width - vim.fn.strdisplaywidth(lineNumbersEllipsis)) .. lineNumbersEllipsis .. " "), -- to support multi-byte utf-8 chars
