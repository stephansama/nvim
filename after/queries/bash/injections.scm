...
; Inject the jsdoc parser into bash comments that begin with an @directive,
; so env-spec / varlock decorators (e.g. @required, @sensitive,
; @type=string(...), @defaultRequired, @import(path)) get per-token
; highlighting via jsdoc's @tag rules.
